...
<div id="header">
    ...
    <p id="menu">
        ...
        <div class="menu_nav">
            ...
            <span class="account">
                <span class="sign_up"><a href="<?php $_SERVER['DOCUMENT_ROOT']?>/user/sign_up.php"><p>Sign Up</p></a></span>
                <span class="login"><a href="<?php $_SERVER['DOCUMENT_ROOT']?>/user/login.php"><p>Login</p></a></span>
            </span>
        </div>
    </p>
</div>